...
aws s3 cp rookie/static/js/combobox.js s3://rookielens/js/combobox.js --acl public-read
aws s3 cp keys.csv.gz s3://rookielens/data/ --acl public-read --content-type text/plain --content-encoding gzip
aws s3 cp searchbar.html.gz s3://rookielens/data/ --acl public-read --content-type text/plain --content-encoding gzip
