...
if (query != "INTRO_MODE"){
    ...
    ReactDOM.render(
      <IntroUI base_url={base_url} y_axis_width={55} w_h_ratio={w_h_ratio} facet_datas={facet_datas} total_docs_for_q={total_docs_for_q} corpus={corpus} chart_bins={chart_bins} q_data={q_data} datas={global_facets} q={""}/>,
      document.getElementById('example')
    );
}
