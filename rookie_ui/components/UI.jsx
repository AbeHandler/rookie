  ...
  */
  ...
  render: function() {
    ...
    if (this.state.mode != "docs" & this.props.total_docs_for_q > 0){
      ...
      let docviewer = <DocViewer height="50" f={this.state.f} handleBinClick={this.handleBinClick} start_selected={this.state.start_selected} end_selected={this.state.end_selected} all_results={this.state.all_results} docs={docs} bin_size={bin_size} bins={binned_facets}/>
