  ...
  */
  ...
  get_tooltip_q: function(){
      ...
      return <svg>
              ...
              <rect x={x_scaled + 5} y={y_loc + 30} height="10" width="10" opacity=".25" fill="#000000"/>
  ...
  render: function() {
    ...
    let l_left, l_right, handle_mouseup;
    ...
    return (
        ...
        <path onMouseLeave={e=>this.setState({mouse_x:-1, mouse_y:-1})} onMouseMove={e =>this.setState({mouse_x:e.pageX})} d={ps} fill="#000000" opacity=".25" stroke="grey"/>
