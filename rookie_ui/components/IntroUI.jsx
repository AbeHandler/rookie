...
var IntroSparklineStatus = require('./IntroSparklineStatus.jsx');
var IntroChart = require('./IntroChart.jsx');
var IntroChartTitle = require('./IntroChartTitle.jsx');
...
module.exports = React.createClass({
          ...
          */
          clickTile: function (e) {
            let url = this.props.base_url + "?q=" + e + "&corpus=" + this.props.corpus;
          ...
          */
          ...
          render: function() {
            ...
            if (this.state.mode != "docs" & this.props.total_docs_for_q > 0){
              main_panel = <Panel>
                            <IntroSparklineStatus fX={this.fX} qX={qX} ndocs={this.props.total_docs_for_q} {...this.props}/>
            ...
            return(
                <div>
                    <QueryBar q={this.props.q} corpus={this.props.corpus}/>
                     <Panel>
                     <IntroChartTitle chartMode={this.state.chart_mode} toggleIntro={this.toggleIntro} turnOnDocMode={this.turnOnDocMode} fX={this.fX} qX={qX} ndocs={this.props.total_docs_for_q} f={this.state.f} mode={this.state.mode} corpus={this.props.corpus}/>
             </Panel>
             {chart}
            <div>
              {main_panel}
