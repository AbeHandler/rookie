...
export default class Chart extends React.Component{
  ...
  */
  ...
  render() {
    ...
    return (
        <Card ref="chart_panel" >
        <Row>
        <Col xs={12}>
        <YAxis max={max} height={this.props.height} y_axis_width={this.props.y_axis_width}/>
        <svg onMouseMove={e=> this.handle_mouse_move(e.pageX, lateral_scale)} onMouseLeave={this.turnoff_drag.bind(this)} onMouseUp={e => handle_mouseup(e.pageX, lateral_scale)} onMouseDown={e => this.handle_mouse_down(e, lateral_scale)} ref="chart" width={this.props.w - this.props.y_axis_width - 5} height={this.props.height}>
